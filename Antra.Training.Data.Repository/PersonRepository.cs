...
namespace Antra.Training.Data.Repository
{
    public class PersonRepository : IRepository<Person>
    {
        ...
        {
            dbConnection = new SqlConnection("Data Source=.;Initial Catalog=University;Integrated Security=True");
        }
        ...
        {
            return dbConnection.Query<Person, Department, Person>(@"Select p.Id, p.LastName,p.FirstName,p.EnrollmentDate,p.HireDate,
p.Discriminator, d.DepartmentID, d.Budget, d.InstructorID, d.Name, d.RowVersion,
d.StartDate
 from Person p inner
 join Department d on p.ID = d.InstructorID", (p, d) => { p.Department = d; return p; } ,
 splitOn: "InstructorID"
 );
